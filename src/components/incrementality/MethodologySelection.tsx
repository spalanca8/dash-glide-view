  ...
  return (
    <Card className="glass-card premium-shadow border-white/30">
      ...
      <CardContent className="space-y-8">
        <div className="bg-purple-50/80 backdrop-blur-sm p-6 rounded-md border border-purple-100 mb-8">
          ...
          <Card className="border border-green-200 bg-white">
            <CardHeader className="pb-3">
              <CardTitle className="text-base flex items-center gap-2">
                ...
                <span className="text-green-7 00">Incrementality Testing</span>
              </CardTitle>
            </CardHeader>
          ...
          <Card className="border border-slate-200 bg-white/80">
            ...
            <CardContent className="pt-0">
              <div className="space-y-3">
                ...
                <div className="极items-center gap-2 text-sm text-slate-600">
                  <XCircle className="h-4 w-4 text-red-400" />
        ...
        <div className="bg-muted/70 backdrop-blur-sm p-6 rounded-md border border-white/20">
          <h3 className="font-medium mb-3">Why Incrementality Testing?</h3>
